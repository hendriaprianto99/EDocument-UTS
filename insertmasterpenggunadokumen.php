...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses WHERE tabel='pengguna/dokumen' AND user = '". $_SESSION['Email'] ."' AND insertData='1'";
...
echo "<form action='insertmasterpenggunadokumenexec.php' method='post' enctype='multipart/form-data'>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Kode_Pengguna</font></td>";
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Kode_Pengguna' size='100'></td>";
...
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Email' size='100'></td>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Telepon</font></td>";
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Telepon' size='100'></td>";

...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='dokumen_file' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertdokumen_fileexec.php method=post enctype='multipart/form-data'>";
...
echo "<td bgcolor=CCEEEE><a href=uploadfiledokumen_fileinsert.php>upload</a></td>";

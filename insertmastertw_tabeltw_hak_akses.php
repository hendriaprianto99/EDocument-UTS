...
<div id="page-wrapper">
    <?php
    // cek otoritas
    $q = "SELECT * FROM tw_hak_akses WHERE tabel='Manage_User_Access' AND user = '" . $_SESSION['Email'] . "' AND insertData='1'";
    ...
    if ($obj = @mysqli_fetch_object($r)) {
        ...
        echo "<form action=insertmastertw_tabeltw_hak_aksesexec.php method=post>";
        echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>tabel</font></td>";
        echo "<td bgcolor=CCEEEE><input type=text class='form-control' name='tabel'></td>";

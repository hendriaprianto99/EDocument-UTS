...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses WHERE tabel='kategori_dokumen/dokumen' AND user = '". $_SESSION['Email'] ."' AND insertData='1'";
...
echo "<form action='insertmasterkategori_dokumendokumenexec.php' method='post' enctype='multipart/form-data'>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Kode</font></td>";
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Kode' size='100'></td>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Kategori</font></td>";
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Kategori' size='100'></td>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Keterangan</font></td>";
echo "<td bgcolor='CCEEEE'><textarea class='form-control' name='Keterangan' cols='70' rows='5'></textarea></td>";

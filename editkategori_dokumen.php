...
<div id="page-wrapper">
    <?php
    //cek otoritas
    $q = "SELECT * FROM tw_hak_akses where tabel='kategori_dokumen' and user = '" . $_SESSION['Email'] . "' and editData='1'";
    ...
    if ($obj = mysqli_fetch_object($r)) {
        ...
        <td bgcolor=F5F5F5 valign=top>
            <table class='table table-striped'>
                ...
                <form action=editkategori_dokumenexec.php method=post>
                    <?php
                    $result = mysqli_query($con, "SELECT * FROM kategori_dokumen where Kode = '" . mysqli_real_escape_string($con, $_GET['Kode']) . "'");
                    while ($row = mysqli_fetch_array($result)) {
                        ?>
                        <tr>
                            <td colspan=2><input type=hidden name=pk value='<?php echo $row['Kode']; ?>'></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Kode&nbsp;&nbsp;</font></td>
                            <td bgcolor=CCEEEE><input type=text class='form-control' name='Kode' value='<?php echo $row['Kode']; ?>' size=100></td>
                        </tr>
                        <tr>
                            <td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Kategori&nbsp;&nbsp;</font></td>
                            <td bgcolor=CCEEEE><input type=text class='form-control' name='Kategori' value='<?php echo $row['Kategori']; ?>' size=100></td>
                        </tr>
                        <tr>
                            <td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Keterangan&nbsp;&nbsp;</font></td>
                            <td bgcolor=CCEEEE><textarea class='form-control' name='Keterangan'><?php echo $row['Keterangan']; ?></textarea></td>
                        </tr>
                        <tr>

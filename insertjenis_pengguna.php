...
<?php
// Cek otoritas
$q = "SELECT * FROM tw_hak_akses WHERE tabel='jenis_pengguna' AND user = '". $_SESSION['Email'] ."' AND insertData='1'";
...
echo "<form action=insertjenis_penggunaexec.php method=post enctype='multipart/form-data'>";

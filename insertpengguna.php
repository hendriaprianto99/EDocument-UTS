...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses WHERE tabel='pengguna' AND user = '". $_SESSION['Email'] ."' AND insertData='1'";
...
echo "<form action='insertpenggunaexec.php' method='post' enctype='multipart/form-data'>";

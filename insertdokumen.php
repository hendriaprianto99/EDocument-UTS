...
<div id="page-wrapper">
    <?php
    //cek otoritas
    $q = "SELECT * FROM tw_hak_akses WHERE tabel='dokumen' AND user = '" . $_SESSION['Email'] . "' AND insertData='1'";
    ...
    ?>
        ...
        echo "<form action=insertdokumenexec.php method=post enctype='multipart/form-data'>";

...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses WHERE tabel='jenis_pengguna/pengguna' AND user = '". $_SESSION['Email'] ."' AND insertData='1'";
...
echo "<form action='insertmasterjenis_penggunapenggunaexec.php' method='post' enctype='multipart/form-data'>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Jenis_Pengguna</font></td>";
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Jenis_Pengguna' size='100'></td>";
echo "<tr><td bgcolor='CCCCCC'><font face='Verdana' color='black' size='1'>Keterangan</font></td>";
echo "<td bgcolor='CCEEEE'><input type='text' class='form-control' name='Keterangan' size='100'></td>";

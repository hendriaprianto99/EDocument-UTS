...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='kategori_dokumen' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action='insertkategori_dokumenexec.php' method='post' enctype='multipart/form-data'>";

...
?>
    ...
    <br><font face="Verdana" color="black" size="1">jenis_pengguna</font><br>
    <br><a href="insertmasterjenis_penggunapengguna.php"><button type="button" class="btn btn-light"><font face="Verdana" color="black" size="1"><i class="fa fa-plus"></i>&nbsp;Insert</font></button></a><br>
    
    <br><form action="listmasterjenis_penggunapengguna.php" method="post">

...
<div id="page-wrapper">
    <?php
    //cek otoritas
    $q = "SELECT * FROM tw_hak_akses where tabel='jenis_pengguna' and user = '" . $_SESSION['Email'] . "' and editData='1'";
        ...
        <td bgcolor=F5F5F5 valign=top>
            <table class='table table-striped'>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <form action=editjenis_penggunaexec.php method=post>
                        <tr>
                            <td colspan=2><input type=hidden name=pk value='<?php echo $row['Jenis_Pengguna']; ?>'></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Jenis_Pengguna&nbsp;&nbsp;</font></td>
                            <td bgcolor=CCEEEE><input type=text class='form-control' name='Jenis_Pengguna' value='<?php echo $row['Jenis_Pengguna']; ?>' size=100></td>
                        </tr>
                        <tr>
                            <td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Keterangan&nbsp;&nbsp;</font></td>
                            <td bgcolor=CCEEEE><input type=text class='form-control' name='Keterangan' value='<?php echo $row['Keterangan']; ?>' size=100></td>
                        </tr>
                        <tr>
